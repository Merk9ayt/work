...
import { StudyTemplateResultPrecisionListViewModel } from './study-template-result-precision-list-view-model';

export class StudyTemplateResultDefinitionViewModel extends ViewModelBase {
  data: StudyTemplateResultDefinitionModel = {
    name: '',
    parameter: {
      id: '',
      name: '',
