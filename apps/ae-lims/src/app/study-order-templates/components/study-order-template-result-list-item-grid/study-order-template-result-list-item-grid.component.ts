...
@Component({
  selector: 'ae-lims-study-order-template-result-list-item-grid',
  templateUrl: './study-order-template-result-list-item-grid.component.html',
  styleUrls: ['./study-order-template-result-list-item-grid.component.scss'],
})
export class StudyOrderTemplateResultListItemGridComponent extends AeBaseComponent {
